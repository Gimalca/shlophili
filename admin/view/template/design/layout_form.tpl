            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'home_slider') { ?>
                    <option value="home_slider" selected="selected"><?php echo $text_home_slider; ?></option>
                    <?php } else { ?>
                    <option value="home_slider"><?php echo $text_home_slider; ?></option>
                    <?php } ?>
                  </select></td>
...
function addModule() {
    ...
    html += '    <option value="home_slider"><?php echo $text_home_slider; ?></option>';
    html += '  </select></td>';
