...
<?php echo $header; ?>
 <div class="breadcrumb">
    ...
    <?php if ($thumb) { ?>
    <img style="max-width: 61%;" src="<?php echo $thumb; ?>" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>"/>
    <?php } ?>
  </div>
  <div class="category-pd fondo-azul">
<div class="container">
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="row">
        <div class="pull-left" style="padding: 0px 15px;">
          ...
          <button style="margin-left: 6px;" type="button" id="grid-view" class="btn btn-default" data-toggle="tooltip" title="<?php echo $button_grid; ?>"><i class="fa fa-th-large"></i></button>
          </div>
        </div>
        
        <!-- <div class="pull-right text-right" style="padding: 0px 15px;">
          <label class="pull-left control-label label-sort hidden-xs" for="input-limit"><?php echo $text_limit; ?> &nbsp;</label>
        ...
        <div class="pull-right text-right" style="padding: 0px 15px;">
          <label class="pull-left control-label label-sort hidden-xs" for="input-sort"><?php echo $text_sort; ?> &nbsp;</label>
      ...
      <!-- comienzo row colecciones-->
      <div class="row">
        <?php foreach ($categories as $categorie) { ?>
        <div class="product-layout product-list col-xs-12">
          <div class="product-thumb category-thumb">
            <div class="image image-list item-product-image-box">
              <a href="<?php echo $categorie['href']; ?>"><img src="<?php echo $categorie['img']; ?>" alt="<?php echo $categorie['name']; ?>" title="<?php echo $categorie['name']; ?>" class="img-responsive" /></a>
              <div class="product-hover-box">
                <a class="a-hover" href="<?php echo $categorie['href']; ?>"></a>
              </div>
            </div>
            <div class="row image-grid">
              ...
              <div class="caption caption-list col-md-8 col-sm-8">
                <h1><a href="<?php echo $categorie['href']; ?>"><?php echo $categorie['name']; ?></a></h1>
                <p class="description"><?php echo $categorie['description']; ?></p>
                <!-- lista -->
        ...
        <div class="product-layout product-list col-xs-12">
          <div class="product-thumb category-thumb">
            <div class="image image-list item-product-image-box">
              ...
              <a><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive" /></a>
              <div class="product-hover-box">
            ...
            <div class="row image-grid">
              ...
              <div class="caption caption-list col-md-8 col-sm-8">
                ...
                <h2><a><?php echo $product['name']; ?></a></h2>        
                <?php if ($product['rating']) { ?>
                  <div class="rating">
                    <?php for ($i = 1; $i <= 5; $i++) { ?>
                      <?php if ($product['rating'] < $i) { ?>
