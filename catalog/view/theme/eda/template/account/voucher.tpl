    ...
    <fieldset class="register-form">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <div class="form-group required">
          <label class="label-custom-size control-label" for="input-to-name"><?php echo $entry_to_name; ?></label>
          <div>
        ...
        <div class="form-group required">
          <label class="label-custom-size control-label" for="input-to-email"><?php echo $entry_to_email; ?></label>
          <div>
        ...
        <div class="form-group required">
          <label class="label-custom-size control-label" for="input-from-name"><?php echo $entry_from_name; ?></label>
          <div>
        ...
        <div class="form-group required">
          <label class="label-custom-size control-label" for="input-from-email"><?php echo $entry_from_email; ?></label>
          <div>
        ...
        <div class="form-group">
          <label class="label-custom-size control-label" for="input-message"><span data-toggle="tooltip" title="<?php echo $help_message; ?>"><?php echo $entry_message; ?></span></label>
          <div class="col-sm-10">
            <textarea name="message" cols="40" rows="5" id="input-message" class="form-control"><?php echo $message; ?></textarea>
          </div>
        </div>
        <div class="form-group">
          <label class="label-custom-size control-label" for="input-amount"><span data-toggle="tooltip" title="<?php echo $help_amount; ?>"><?php echo $entry_amount; ?></span></label>
          <div class="col-sm-10">
        ...
        <div class="buttons clearfix" style="padding-top: 5px;">
          <div class="pull-left btn-create-account"> <?php echo $text_agree; ?>
            <?php if ($agree) { ?>
