    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">    
        <fieldset class="register-form">
          <h2 class="legend"><?php echo $text_order; ?></h2>
          <p style="font-size: 12px; padding-bottom: 20px;"><?php echo $text_description; ?></p>
          <div class="form-group required">
            <label class="label-custom-size control-label" for="input-firstname"><?php echo $entry_firstname; ?></label>
            <div>
          ...
          <div class="form-group required">
            <label class="label-custom-size control-label" for="input-lastname"><?php echo $entry_lastname; ?></label>
            <div>
          ...
          <div class="form-group required">
            <label class="label-custom-size control-label" for="input-email"><?php echo $entry_email; ?></label>
            <div>
          ...
          <div class="form-group required">
            <label class="label-custom-size control-label" for="input-telephone"><?php echo $entry_telephone; ?></label>
            <div>
          ...
          <div class="form-group required">
            <label class="label-custom-size control-label" for="input-order-id"><?php echo $entry_order_id; ?></label>
            <div>
          ...
          <div class="form-group">
            <label class="label-custom-size control-label" for="input-date-ordered"><?php echo $entry_date_ordered; ?></label>
            <div>
        ...
        <fieldset class="register-form">
          <h2 class="legend"><?php echo $text_product; ?></h2>
          <div class="form-group required">
            <label class="label-custom-size control-label" for="input-product"><?php echo $entry_product; ?></label>
            <div>
          ...
          <div class="form-group required">
            <label class="label-custom-size control-label" for="input-model"><?php echo $entry_model; ?></label>
            <div>
          ...
          <div class="form-group">
            <label class="label-custom-size control-label" for="input-quantity"><?php echo $entry_quantity; ?></label>
            <div>
              <input type="text" name="quantity" value="<?php echo $quantity; ?>" placeholder="<?php echo $entry_quantity; ?>" id="input-quantity" class="form-control" />
            </div>
          </div>
          <div class="form-group required">
            <label class="label-custom-size control-label"><?php echo $entry_reason; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="label-custom-size control-label"><?php echo $entry_opened; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="label-custom-size control-label" for="input-comment"><?php echo $entry_fault_detail; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="label-custom-size control-label" for="input-captcha"><?php echo $entry_captcha; ?></label>
            <div class="col-sm-10">
