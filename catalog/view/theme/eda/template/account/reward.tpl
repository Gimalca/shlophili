...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <p><?php echo $text_total; ?> <?php echo $total; ?>.</p>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 text-right" style="font-size: 12px;"><?php echo $results; ?></div>
      </div>
      <div class="buttons clearfix">
        <div class="pull-right btn-create-account"><a href="<?php echo $continue; ?>" class="btn btn-primary"><?php echo $button_continue; ?></a></div>
      </div>
