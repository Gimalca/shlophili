...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?> content-cart"><?php echo $content_top; ?>
          ...
          <table class="table table-bordered">
            ...
            <tbody class="tbody-form">
              ...
              <tr>
                ...
                <td class="text-right price-text"><?php echo $product['price']; ?></td>
                <td class="text-right price-text"><?php echo $product['total']; ?></td>
              </tr>
              <?php } ?>
              <!--  
      ...
      <!-- <h2 class="voucher-title"><?php echo $text_next; ?></h2> -->
      <!-- <p style="font-size: 12px; padding-bottom: 10px;"><?php echo $text_next_choice; ?></p> -->
      ...
      <div class="row">
        <div class="col-sm-4 col-sm-offset-8">
          <table class="table table-bordered">
            ...
            <tr>
              <td class="text-right price-total"><strong><?php echo $total['title']; ?>:</strong></td>
      ...
      <div class="buttons btn-create-account">
        <div class="pull-left"><a href="<?php echo $continue; ?>" class="button-shoping"><?php echo $button_shopping; ?></a></div>
