<?php echo $header; ?>
<div class="category-pd-checkout fondo-azul">
<div class="container">
  ...
  <?php } ?>
  <div class="row login-content"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?> content-check-out"><?php echo $content_top; ?>
      <h1 class="heading_title-checkout"><?php echo $heading_title; ?></h1>
      <div class="panel-group" id="accordion">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title panel-title-checkout"><?php echo $text_checkout_option; ?></h4>
          </div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title panel-title-checkout"><?php echo $text_checkout_account; ?></h4>
          </div>
          <div class="panel-collapse collapse" id="collapse-payment-address" style="color: #000 !important;">
            <div class="panel-body"></div>
          </div>
        </div>
        <?php } else { ?>
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title panel-title-checkout"><?php echo $text_checkout_payment_address; ?></h4>
          </div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title panel-title-checkout"><?php echo $text_checkout_shipping_address; ?></h4>
          </div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading panel-title-checkout">
            <h4 class="panel-title panel-title-checkout"><?php echo $text_checkout_shipping_method; ?></h4>
          </div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title panel-title-checkout"><?php echo $text_checkout_payment_method; ?></h4>
          </div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title panel-title-checkout"><?php echo $text_checkout_confirm; ?></h4>
          </div>
