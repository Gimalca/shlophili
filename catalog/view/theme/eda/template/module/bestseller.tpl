...
<div class="row product-layout product-slider product-list-slider slide-bestseller-<?php echo $id_slide_bestseller ?> hidden-buttons">
<div class="slides">
  ...
  <div class="product-inner">
    <div class="product-thumb transition">
      ...
      <div class="name pull-left">
        <button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span></button></div>
...
$('.slide-bestseller-<?php echo $id_slide_bestseller ?> .slides').owlCarousel({
