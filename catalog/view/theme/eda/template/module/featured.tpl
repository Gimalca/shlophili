...
<div class="row product-layout product-slider product-list-slider slide-featured-id-<?php echo $id_slide_featured ?> hidden-buttons">
<div class="slides">
...
$('.slide-featured-id-<?php echo $id_slide_featured ?> .slides').owlCarousel({
