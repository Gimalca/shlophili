<?php 
	...
	$id_slide_latest = rand();
?>
<div class="latest-product-content">
<h3 class="spb_heading"><p><?php echo $heading_title; ?></p><div class="heading-icon"></div></h3>
<div class="row product-layout product-slider product-list-slider slide-latest-id-<?php echo $id_slide_latest ?> hidden-buttons">
<div class="slides">
...
$('.slide-latest-id-<?php echo $id_slide_latest ?> .slides').owlCarousel({
